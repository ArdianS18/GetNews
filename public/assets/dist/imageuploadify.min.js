...
(function ($, window, document, undefined) {
	...
	$.fn.imageuploadify = function (opts) {
		...
		this.each(function () {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class="col-form-label text-lg mt-4" style="color: #697A8D;">Drag and drop your image here</span><br><span class="col-form-label text-lg mt-4" style="color: #697A8D;">Or</span><br><button type="button" class="btn btn-md  mb-5" style="background-color: #E7E7FF; color: #696CFF">or select file to upload</button><br></div></div>`);
