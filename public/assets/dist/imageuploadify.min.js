		...
		this.each(function () {
			...
			let dragbox = $(`<div class="imageuploadify well">
								...
								<div class="imageuploadify-images-list text-center">
									...
									<div class mt-3>
										<span class="col-form-label text-lg mb-3 mt-4" style="color: #697A8D;">Drag and drop your image here</span><br>
									</div>
									<div class="mt-3">
										<span class="col-form-label text-lg mt-5" style="color: #697A8D;">or</span><br>
									</div>
									<div class="mt-3">
										<button type="button" class="btn btn-md  mb-5" style="background-color: #E7E7FF; color: #696CFF">select file to upload</button><br>
									</div
								</div>
							</div>`
			);
