...
class PaymentNewsRepository extends BaseRepository implements PaymentNewsInterface
{
    public function __construct(PaymentNews $paymentNews)
    {
        $this->model = $paymentNews;
    }
