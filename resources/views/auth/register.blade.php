                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row justify-content-between mt-2">
                                <div class="col-lg-6 col-md-12 from-outline mb-2">
                                    ...
                                    <input id="nomor" type="text" placeholder="Nomor Hp"
                                        class="gap-8 form-control form-control-lg @error('nomor') is-invalid @enderror"
                                        name="nomor" value="{{ old('name') }}" required autocomplete="name"
                                        autofocus>
                                ...
                                <div class="col-lg-6 col-md-12 from-outline mb-2 padding-right-2">
                                    ...
                                    <input id="email" type="email" placeholder="email"
                                        class="gap-8 form-control form-control-lg @error('email') is-invalid @enderror"
                            ...
                            <div class="from-outline mt-2 mb-4">
                                ...
                                <textarea name="alamat" id="alamat" placeholder="Masukan Alamat" cols="10" rows="5"
                                    class="form-control form-control-lg @error('alamat') is-invalid @enderror" value="{{ old('alamat') }}" required
                            ...
                            <div class="text-center mt-4 mb-4">
                                <button type="submit" class="btn btn-lg text-white"
                                    style="padding-left: 18rem; padding-right: 18rem; background-color: #0F4D8A;">
                                    Daftar
                                </button>
                            </div>
