            ...
            <ul id="sidebarnav">
              <li class="nav-small-cap">
                ...
                <li class="sidebar-item">
                    <a class="  text-white sidebar-link {{ request()->routeIs('profile.user' ? 'active' : '') }}"
                        href="{{ route('profile.user', ['user' => auth()->user()]) }}" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="text-white sidebar-link {{ request()->routeIs('user.inbox' ? 'active' : '') }}"
                ...
                <li class="sidebar-item">
                    <a class="text-white sidebar-link {{ request()->routeIs('tukar.coin' ? 'active' : '') }}"
                ...
                <li class="text-white sidebar-item">
                    <a class="text-white sidebar-link has-arrow" href="#" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                      <li class="sidebar-item">
                        <a href="{{route('berita.upload')}}" class="text-white sidebar-link">
                      ...
                      <li class="sidebar-item">
                        <a href="{{route('status.berita')}}" class="text-white sidebar-link">
                          <div class="round-16 d-flex align-items-center justify-content-center">
                            <i class="ti ti-circle"></i>
                          </div>
                ...
                <li class="sidebar-item">
                  ...
                  <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                      <a href="{{route('iklan.biodata')}}" class="text-white sidebar-link">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                          <i class="ti ti-circle"></i>
                        </div>
                    ...
                    <li class="sidebar-item">
                      <a href="{{route('iklan.status')}}" class="text-white sidebar-link">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                          <i class="ti ti-circle"></i>
                        </div>
                ...
                <li class="sidebar-item">
                    <a class="text-white sidebar-link"
