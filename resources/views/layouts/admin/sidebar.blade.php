            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('faq.admin' ? 'active' : '') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="25" height="25" viewBox="0 0 14 14"><circle cx="7" cy="7" r="6.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.5 5.5A1.5 1.5 0 1 1 7 7v1"/><path fill="currentColor" d="M7 9.5a.75.75 0 1 0 .75.75A.76.76 0 0 0 7 9.5Z"/></svg>
                        <span class="hide-menu text-white">Faq</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('tag.detail.list' ? 'active' : '') }}"
                        href="{{ route('tag.detail.list') }}" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="25" height="25" viewBox="0 0 24 24"><path fill="currentColor" d="M3 23V7q0-.825.588-1.412T5 5h10q.825 0 1.413.588T17 7v16l-7-3zm2-3.05l5-2.15l5 2.15V7H5zM19 20V3H6V1h13q.825 0 1.413.588T21 3v17zM5 7h10z"/></svg>
                        <span class="hide-menu text-white">Tag</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('report.index' ? 'active' : '') }}"
                        href="{{ route('report.index') }}" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="25" height="25" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m7 9l3.75 3a2 2 0 0 0 2.5 0L17 9m4 8V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2"/></svg>
                        <span class="hide-menu text-white">Inbox</span>
                    </a>
                </li>
                <li class="nav-small-cap">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->routeIs('kategori.admin' ? 'active' : '') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-white" width="25" height="25" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 8h5m0 4h-5m5 4h-5m-5 4h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2m2-4"/></svg>
                        <span class="hide-menu text-white">Kategori</span>
                    </a>
                </li>
                <li class="nav-small-cap">
