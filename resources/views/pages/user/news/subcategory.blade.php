        ...
        <div class="modal fade searchModal" id="searchModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form >
                        <input type="search" name="cari" class="form-control" placeholder="Search nsdufuyhgygytere....">
                        <button type="submit"><i class="fi fi-rr-search"></i></button>
                        <button type="submit" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i
                ...
                <div class="row gx-55 gx-5">
                    <div class="col-lg-8">
                        <div class="row justify-content-center">
                                ...
                                <div class="news-card-thirteen">
                                    ...
                                    <div class="news-card-info">
                                        ...
                                        <ul class="news-metainfo list-style">
                                            <li><i class="fi fi-rr-calendar-minus"></i><a href="news-by-date.html">{{ $newsSubCategory->news->created_at->format('M d, Y') }}</a></li>
                                            <li><i class="fi fi-rr-eye"></i>{{ $newsSubCategory->news->views->count() }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-6">
                                <div class="news-card-thirteen">
                                    <div class="news-card-img">
                                        <img src="{{ asset('assets/img/test1.svg') }}" width="400px" height="234"
                                            style="width: 100%;height:100%;" alt="Iamge">
                                        <a href="kesehatan.html" class="news-cat">{{ $subCategory->name }}</a>
                                    </div>
                                    <div class="news-card-info">
                                        <h3><a href="kesehatan-details.html">Recovery And Cleanup In Florida After Hurricane
                                                Ian</a></h3>
                                        <ul class="news-metainfo list-style">
                            ...
                            <div class="col-md-6">
                                <div class="news-card-thirteen">
                                    ...
                                    <div class="news-card-info">
                                        <h3><a href="kesehatan-details.html">Recovery And Cleanup In Florida After
                                                Hurricane Ian</a></h3>
                                        <ul class="news-metainfo list-style">
                                            <li><i class="fi fi-rr-calendar-minus"></i><a href="news-by-date.html">Feb 27,
                                                    2023</a></li>
                        ...
                        <ul class="page-nav list-style text-center mt-20">
                            <li><a href="{{ $newsSubCategories->previousPageUrl() }}"><i class="flaticon-arrow-left"></i></a></li>
                            @for ($i = 1; $i <= $newsSubCategories->lastPage(); $i++)
                            <li><a href="{{ $newsSubCategories->url($i) }}" class="btn btn-black {{ $newsSubCategories->currentPage() == $i ? 'active' : '' }}">{{ $i }}</a></li>
                            @endfor
                            <li><a href="{{ $newsSubCategories->nextPageUrl() }}"><i class="flaticon-arrow-right"></i></a></li>
                        </ul>
                    </div>
