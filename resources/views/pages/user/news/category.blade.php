                        ...
                        <div class="col-md-6">
                            <div class="news-card-thirteen">
                                ...
                                <div class="news-card-info">
                                    <h3><a href="{{ route('news.user', ['news' => $newsCategory->news->slug,'year'=> $dateParts['year'],'month'=>$dateParts['month'],'day'=> $dateParts['day'] ]) }}">{!! Illuminate\Support\Str::limit(strip_tags($newsCategory->news->name), 50, '...') !!}</a></h3>
