...
<head>
    ...
    <meta property="og:url"
        content="media.mijurnal.com/berita/{{ $dateParts['year'] }}/{{ $dateParts['month'] }}/{{ $dateParts['day'] }}/{{ $news->slug }}">
...
@section('script')
    ...
    <script>
        ...
        function shareOnWhatsapp(newsId) {
            var url = 'https://media.mijurnal.com/berita/{{ $dateParts['year'] }}/{{ $dateParts['month'] }}/{{ $dateParts['day'] }}/{{ $news->slug }}';
