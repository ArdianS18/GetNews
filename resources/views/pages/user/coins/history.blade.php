    ...
    {{-- <div class="card p-4">
        <div class="row justify-content-between">
            ...
            <div class="col-2">
                ...
                <p class="mt-3">Tanggal : 01/05/2022</p>
            </div>

            <div class="col-1" style="border-left: 1px solid #888888"></div>
            <div class="col-2">
    ...
    <div class="card p-4">
        <div class="d-flex justify-content-between">
            <div class="d-flex">
                ...
                <div class="ms-5 me-5" style="border-left: 1px solid #888888"></div>
                <div class="">
                    <p>Nominal: 50 Koin /Rp.500</p>
                    <div class="d-flex">
                        <span>Metode Penarikan :</span>
