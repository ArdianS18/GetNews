...
<div class="card shadow-sm position-relative overflow-hidden" style="background-color: #183249;">
    <div class="card-body">
      <div class="row justify-content-between">
        <div class="col-8 text-white">
          <h4 class="fw-semibold mb-3 mt-2 col-12 text-white">Jumlah Koin</h4>
          <div class="d-flex">
            ...
            <h5 class="text-white mt-1 col-6">Rp. 12.000</h5>
          </div>
        </div>
        <div class="col-3">
    ...
    <div class="card-footer py-2" style="background-color: #222222;">
        <div class="d-flex justify-content-between">
            <h5 class="text-white mt-1 col-4 fs-3">Rp. 12.000</h5>

            <div class="d-flex justify-content-end col-8">
                <a href="{{route('user.history.coin')}}" class="text-white fs-3">Riwayat</a>
                <span class="ms-3 me-3 text-white">|</span>
                <a href="{{route('user.tukar.coin')}}" class="text-white fs-3">
