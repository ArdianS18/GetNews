...
<div class="">
    <div class="card-profile">
        <div class="card-body p-0">
          <img src="{{asset('assets/img/profile-bg.svg')}}" width="100%" height="150px" style="border-radius: 10px 10px 0 0;" alt="" class="img-fluid">
          <div class="top-right">
                ...
                <div class="mt-n5">
                  <div class="d-flex align-items-center justify-content-center mt-3 mb-2">
                    <div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 110px; height: 110px;";>
                      <div class="border border-4 mt-4 border-white d-flex align-items-center justify-content-center rounded-circle overflow-hidden" style="width: 100px; height: 100px;";>
        ...
        <div class="shadow-sm" style="background-color: #ECF1F4;">
            <ul class="nav nav-pills user-profile-tab justify-content-end mt-2 rounded-2" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link position-relative active rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" id="pills-berlangganan-tab" data-bs-toggle="pill" data-bs-target="#pills-berlangganan" type="button" role="tab" aria-controls="pills-berlangganan" aria-selected="false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2" width="20" height="20" viewBox="0 0 256 256"><path fill="currentColor" d="M181.92 153A55.58 55.58 0 0 1 137 197.92a7 7 0 0 1-1 .08a6 6 0 0 1-1-11.92c17.38-2.92 32.13-17.68 35.08-35.08a6 6 0 1 1 11.84 2m32.08-9a86 86 0 0 1-172 0c0-27.47 10.85-55.61 32.25-83.64a6 6 0 0 1 9-.67l26.34 25.56l23.09-63.31a6 6 0 0 1 9.47-2.56C163.72 37.33 214 85.4 214 144m-12 0c0-48.4-38.65-89.84-61.07-109.8l-23.29 63.86a6 6 0 0 1-9.82 2.25l-28-27.22C62.67 97.13 54 121 54 144a74 74 0 0 0 148 0"/></svg>
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-sm px-4 py-2 text-white m-4" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{$user->id}}" style="background-color: #175A95;">Daftar Jadi Penulis</button>
        </div>

        <div class="tab-pane fade show active card-detail" id="pills-berlangganan" role="tabpanel" aria-labelledby="pills-berlangganan-tab" tabindex="0">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th class="text-white" style="background-color: #175A95; border-radius: 5px 0 0 5px;">Paket</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td></td>
                        <td>                                    
                            <button type="submit" style="background-color: #175A95" class="btn btn-sm btn-delete ms-2 text-white"
                            data-id="">
        ...
        <div class="tab-pane fade card-detail shadow-sm" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
            <div class="row mt-5 ps-5 pe-5">
                ...
                <div class="col-md-12 col-lg-6 mb-3">
                    ...
                    <input id="name" type="text" placeholder="" class="form-control form-control-lg @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" readonly required autocomplete="name" autofocus>
                ...
                <div class="col-md-12 col-lg-6 mb-3">
                    ...
                    <input id="phone_number" type="text" placeholder="" class="form-control form-control-lg @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ $user->phone_number }}" readonly required autocomplete="name" autofocus>
                ...
                <div class="col-md-12 col-lg-6 mb-3">
                    ...
                    <input id="email" type="text" placeholder="" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{$user->email}}" readonly required autocomplete="name" autofocus>
                ...
                <div class="col-md-12 col-lg-6 mb-3">
                    ...
                    <input id="name" type="date" placeholder="" class="form-control form-control-lg @error('created_at') is-invalid @enderror" name="created_at" value="{{ $user->created_at }}" readonly required autocomplete="name" autofocus>
                ...
                <div class="col-md-12 col-lg-12 mb-3">
                    ...
                    <textarea name="alamat" placeholder="{{$user->address}}" readonly class="form-control" id="" rows="7"></textarea>
                </div>
