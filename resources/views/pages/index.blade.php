...
<div class="container-fluid pb-75">
    <div class="news-col-wrap">
        <div class="news-col-one">
            ...
            @endphp
            @if ($counter < 1) <div class="news-card-two">
                <div class="news-card-img">
                    <a href="{{ route('news.user', ['news' => $newss->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                        <img src="{{ asset('storage/' . $newss->photo) }}" class="img-responsive" style="object-fit: cover;" width="100%" alt="Image" height="250" />
                    </a>
        ...
        @elseif ($counter < 4) <div class="news-card-three">
            <div class="news-card-img">
                <a href="{{ route('news.user', ['news' => $newss->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
            ...
            <div class="news-card-info">
                ...
                <ul class="news-metainfo list-style">
                    <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($newss->created_at)->translatedFormat('d F Y') }}</a>
                    </li>
                    <li><i class="fi fi-rr-eye"></i>{{ $newss->views_count }}</li>
...
<div class="news-col-two">
    ...
    @endphp
    @if ($counter < 1) <div class="news-card-four">
        <div class="news-card-img">
            <a href="{{ route('news.user', ['news' => $mid->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                <img src="{{ asset('storage/' . $mid->photo) }}" class="img-responsive" alt="Image" width="100%" style="object-fit: cover" height="450" />
            </a>
        </div>
...
@elseif ($counter < 3) <hr>
    <div class="news-card-five">
        <div class="news-card-img">
            <a href="{{ route('news.user', ['news' => $mid->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                <img src="{{ asset('storage/' . $mid->photo) }}" class="img-responsive" alt="Image" height="150" width="100%" />
            </a>
    ...
    <div class="news-col-three">
        ...
        @endphp
        @if ($counters < 1) <div class="news-card-two">
            <div class="news-card-img">
                <a href="{{ route('news.user', ['news' => $barus->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                    <img src="{{ asset('storage/' . $barus->photo) }}" class="img-responsive" style="object-fit: cover;" alt="Image" height="250" width="100%" />
                </a>
    ...
    @elseif ($counters < 4) <div class="news-card-three">
        <div class="news-card-img">
            <a href="{{ route('news.user', ['news' => $barus->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                <img src="{{ asset('storage/' . $barus->photo) }}" class="img-responsive" style="object-fit:cover;" width="100%" height="100" alt="Image" />
            </a>
        </div>
        <div class="news-card-info">
            ...
            <ul class="news-metainfo list-style">
                <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($barus->created_at)->translatedFormat('d F Y') }}</a>
                </li>
                <li><i class="fi fi-rr-eye"></i>{{ $barus->views_count }}</li>
            </ul>
        </div>
                                            ...
                                            <div class="news-card-six">
                                                <div class="news-card-img">
                                                    <a href="{{ route('news.user', ['news' => $pick->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                                                        <img src="{{ asset('storage/' . $pick->photo) }}" class="img-responsive" width="100%" height="220" style="object-fit: cover;" alt="Image" />
                                                    </a>
                                                </div>
                                                <div class="news-card-info">
                                                    <div class="news-author">
                                                        <div class="news-author-img">
                                                            <a href="{{ route('news.user', ['news' => $pick->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">
                                                                <img src="{{ asset($pick->user->photo ? 'storage/' . $pick->user->photo : 'default.png') }}" alt="Image" width="40px" height="40px" style="border-radius: 50%; object-fit:cover;" />
                                                            </a>
                                                        </div>
                                                    ...
                                                    <ul class="news-metainfo list-style">
                                                        <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($pick->created_at)->translatedFormat('d F Y') }}</a>
                                                        </li>
                            ...
                            <div class="tab-content news-tab-content">
                                <div class="tab-pane fade show active" id="tab_10" role="tabpanel">
                                    ...
                                    <div class="news-card-seven">
                                        <div class="news-card-img">
                                            <img src="{{ asset('storage/' . $popular->photo) }}" class="img-responsive" alt="Image" width="100%" height="110" style="object-fit: cover" />
                                        </div>
                                        <div class="news-card-info">
                                            ...
                                            <ul class="news-metainfo list-style">
                                                <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($popular->created_at)->translatedFormat('d F Y') }}</a>
                                                </li>
                                ...
                                <div class="tab-pane fade" id="tab_11" role="tabpanel">
                                    ...
                                    <div class="news-card-seven">
                                        <div class="news-card-img">
                                            <img src="{{ asset('storage/' . $recent->photo) }}" class="img-responsive" alt="Image" width="100%" height="110" style="object-fit: cover" />
                                        </div>
                                        <div class="news-card-info">
                                            ...
                                            <ul class="news-metainfo list-style">
                                                <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($recent->upload_date)->translatedFormat('d F Y') }}</a>
                                                </li>
                ...
                <div class="row gx-55">
                    <div class="col-xl-6">
                        <div class="row">
                            ...
                            @endphp
                            @if ($counters < 1) <div class="col-12">
                                <div class="news-card-eleven">
                                    <div class="news-card-img">
                                        <img src="{{ asset('storage/' . $most->photo) }}" classimg-responsive="100%" height="500" style="object-fit: cover;" alt="Image" />
                                    </div>
                                    <div class="news-card-info">
                                        <div class="news-author">
                                            <div class="news-author-img">
                                                <img src="{{ asset($most->user->photo ? 'storage/' . $most->user->photo : 'default.png') }}" alt="Image" width="40px" height="40px" style="border-radius: 50%; object-fit:cover;" />
                                            </div>
                                            <h5>By <a href="{{ route('author.detail', ['id' => $most->user->slug]) }}">{{ $most->user->name }}</a>
                                            </h5>
                                        </div>
                                        <h3>
                                        ...
                                        <ul class="news-metainfo list-style">
                                            <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($most->created_at)->translatedFormat('d F Y') }}</a>
                                            </li>
                ...
                <div class="col-xl-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="news-card-six">
                                <div class="news-card-img">
                                    <img src="{{ asset('storage/' . $most2->photo) }}" class="img-responsive" width="100%" height="250" style="object-fit: cover;" alt="Image" />
                                ...
                                <div class="news-card-info">
                                    <div class="news-author">
                                        <div class="news-author-img">
                                            <img src="{{ asset($most2->user->photo ? 'storage/' . $most2->user->photo : 'default.png') }}" alt="Image" width="40px" height="40px" style="border-radius: 50%; object-fit:cover;" />
                                        </div>
                                        <h5>By <a href="{{ route('author.detail', ['id' => $most2->user->slug, 'year' => $dateParts['year'], 'month' => $dateParts['month'], 'day' => $dateParts['day']]) }}">{{ $most2->user->name }}</a>
                                        </h5>
                                    </div>
                                    <h3>
                                    ...
                                    <ul class="news-metainfo list-style">
                                        <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($most2->created_at)->translatedFormat('d F Y') }}</a>
                                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="news-card-twelve">
                                    <div class="news-card-img">
                                        <img src="{{ asset('storage/' . $general->photo) }}" class="img-responsive" alt="Image" width="100%" height="130" style="object-fit: cover" />
                                    </div>
                                    <div class="news-card-info">
                                        ...
                                        <ul class="news-metainfo list-style">
                                            <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($general->upload_date)->translatedFormat('d F Y') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="row gx-5">
                            <div class="col-xl-7">
                                <div class="scrollscreen">
                                    ...
                                    <div class="news-card-five">
                                        <div class="news-card-img">
                                            <img src="{{ asset('storage/' . $news_latest->photo) }}" class="img-responsive" alt="Image" width="100%" height="110" style="object-fit: cover" />
                                        ...
                                        <div class="news-card-info">
                                            ...
                                            <ul class="news-metainfo list-style">
                                                <li><i class="fi fi-rr-calendar-minus"></i><a href="javascript:void(0)">{{ \Carbon\Carbon::parse($news_latest->upload_date)->translatedFormat('d F Y') }}</a>
                                                </li>
                            ...
                            <div class="col-xl-5">
                                ...
                                @if ($counter < 1) <div class="news-card-two">
                                    <div class="news-card-img">
                                        ...
                                        <a href="{{ route('categories.show.user', ['category' => $news_latest2->newsCategories[0]->category->slug]) }}" class="news-cat">{{ $news_latest2->newsCategories[0]->category->name }}</a>
                                    </div>
                                    <div class="news-card-info">
                                        <h3>
                            ...
                            @elseif ($counter < 3) <div class="news-card-three">
                                <div class="news-card-img">
                                    <img src="{{ asset('storage/' . $news_latest2->photo) }}" class="img-responsive" alt="Image" />
                                </div>
                                <div class="news-card-info">
            ...
            <div class="sidebar">
                <div class="sidebar-widget">
                    ...
                    <ul class="category-widget list-style">
                        ...
                        <li><a data-toggle="tooltip" data-placement="top" title="{{ $category->name }}" href="{{ route('categories.show.user', ['category' => $category->slug]) }}"><i class="flaticon-right-arrow"></i>{{ $category->name }}
