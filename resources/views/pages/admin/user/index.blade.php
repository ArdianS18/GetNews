                ...
                <tbody>
                    @forelse($authors as $author)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <button class="btn btn-sm btn-primary btn-detail me-2" style="background-color:#0F4D8A"
                                        data-id="{{ $author->id }}" data-name="{{ $author->user->name }}"
                                        data-nomor="{{ $author->user->phone_number }}"
                                        data-email="{{ $author->user->email }}" data-photo="{{ $author->user->photo }}"
                                        data-alamat="{{ $author->user->address }}" id="btn-detail-{{ $author->user->id }}">
