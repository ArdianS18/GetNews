                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <!-- Detail Modal toggle -->
                            <button data-bs-toggle="tooltip" title="Detail" class="btn btn-sm btn-primary btn-detail me-2" style="background-color:#0F4D8A" data-id="{{ $author->id }}"
                            ...
                            <a data-bs-toggle="tooltip" title="Blokir" href="{{ route('banned.author', ['author' => $author->id]) }}" class="btn btn-sm btn-danger">
