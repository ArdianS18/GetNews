                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <input type="datetime-local" id="upload_date" name="upload_date" placeholder="date" value="{{ $news->upload_date }}" class="form-control @error('upload_date') is-invalid @enderror">
                            @error('upload_date')
                            <span class="invalid-feedback" role="alert" style="color: red">
                                <strong>{{ $message }}</strong>
                            </span>
