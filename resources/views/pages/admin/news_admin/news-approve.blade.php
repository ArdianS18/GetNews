                            ...
                            <td>
                                ...
                                <div class="d-flex">
                                    <a data-bs-toggle="tooltip" title="Detail"
                                        href="{{ route('detail.news.admin', ['news' => $news->id]) }}"
                                        class="btn btn-sm btn-primary btn-detail" style="background-color:#0F4D8A">
                                    ...
                                    <button data-bs-toggle="tooltip" title="Hapus" type="submit"
                                        style="background-color: #EF6E6E" class="btn btn-sm btn-delete ms-2 text-white"
                                        data-id="{{ $news->id }}">
                                    ...
                                    @if ($news->is_primary == 1)
                                        <button data-bs-toggle="tooltip" title="berita di pin"
                                            class="btn btn-sm btn-warning ms-2">
                                            <i><svg xmlns="http://www.w3.org/2000/svg" width="21"height="21"
                                                    viewBox="0 0 24 24">
